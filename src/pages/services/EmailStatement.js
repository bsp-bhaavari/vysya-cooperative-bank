    ...
    <div className="section-padding">
      <div className="container-max">
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Statement by Email</h1>
            ...
            <Card key={index} className="group hover:shadow-premium-sm transition-all duration-300">
              <CardContent>
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-primary-100 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                    <Clock className="w-6 h-6 text-primary-600" />
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">{item.period}</h3>
        ...
        <Card className="bg-gradient-to-r from-primary-50 to-secondary-50">
          <CardContent>
            <div className="text-center py-4">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Charges</h3>

...
const VasaviHousingLoan = () => {
  const features = [
    'Special housing loan for Vasavi members',
    ...
    <div className="section-padding">
      <div className="container-max">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-trust-900 mb-4">Vasavi Housing Loan</h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Special housing loan scheme designed for Vasavi cooperative members with 
        ...
        <div className="bg-gradient-to-r from-trust-50/50 to-gold-50/50 rounded-xl p-8 mb-12">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-4 mb-6">
              <Home className="w-12 h-12 text-trust-600" />
              <h3 className="text-2xl font-bold text-trust-900">Dream Home</h3>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-trust-600 mb-2">30</div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-trust-600 mb-2">95%</div>
...
export default VasaviHousingLoan;

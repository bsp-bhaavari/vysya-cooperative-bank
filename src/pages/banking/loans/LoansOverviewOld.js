...
const LoansOverview = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Loan Services</h1>
      ...
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Individual Loans</h2>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  <div className={`w-12 h-12 ${
                    loan.color === 'primary' ? 'bg-primary-100' : 'bg-secondary-100'
                  } rounded-lg flex items-center justify-center flex-shrink-0`}>
                    {React.createElement(loan.icon, { 
                      className: `w-6 h-6 ${loan.color === 'primary' ? 'text-primary-600' : 'text-secondary-600'}` 
                    })}
                  </div>
      ...
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Business Loans</h2>
            ...
            <Card key={index} className="group cursor-pointer">
              <CardContent className="p-6">
                <div className={`w-16 h-16 ${
                  ...
                  {React.createElement(loan.icon, { 
                    className: `w-8 h-8 ${loan.color === 'primary' ? 'text-primary-600' : 'text-secondary-600'}` 
                  })}
                </div>

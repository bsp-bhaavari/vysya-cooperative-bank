    ...
    <div className="section-padding">
      <div className="container-max">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Vasavi Installment Loan</h1>
        ...
        <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-xl p-8 mb-12">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900">Flexible Repayment</h3>
            </div>
        ...
        <div className="text-center mt-12">
          ...
          >
            Apply for Vasavi Installment Loan
          </Link>
        </div>
      </div>
    </div>
...
export default VasaviInstallmentLoan;

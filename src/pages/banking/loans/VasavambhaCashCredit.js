...
const VasavambhaCashCredit = () => {
  const features = [
    'Cash credit facility for Vasavambha members',
    ...
    <div className="section-padding">
      <div className="container-max">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Vasavambha Cash Credit</h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Cash credit facility designed for Vasavambha cooperative members with 
        ...
        <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-xl p-8 mb-12">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900">Working Capital</h3>
            </div>
        ...
        <div className="text-center mt-12">
          ...
          >
            Apply for Vasavambha Cash Credit
          </Link>
        </div>
      </div>
    </div>
...
export default VasavambhaCashCredit;
